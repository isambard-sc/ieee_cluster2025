...
nsys profile -y 360 -d 720 --trace=cuda,cudnn,cublas,osrt,nvtx --event-sample=system-wide \
-w true -c cudaProfilerApi -o sft_llama2_7B_4workers  \ 
python3 /projects/t5c/public/NeMo/examples/nlp/language_modeling/tuning/megatron_gpt_finetuning.py trainer.precision=bf16 \
trainer.devices=1 \
trainer.num_nodes=1 \
...
exp_manager.explicit_log_dir=tmp/ \
